...
class CountCardPlayerUseCaseTest {
    ...
    void setUp() {
        ...
        countCardPlayerUseCase = new CountCardPlayerUseCase(gameRepository, removePlayerUseCase);
    }

    @Test
    void countCardsPlayersTest() {
        ...
        StepVerifier.create(countCardPlayerUseCase.apply(game))
