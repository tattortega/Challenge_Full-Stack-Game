...
class BetCardUseCaseTest {

    @SpyBean
    BetCardUseCase betCardUseCase;
    @MockBean
    ...
    void setUp() {
        ...
        betCardUseCase = new BetCardUseCase(gameRepository,comparateCardsInGameUseCase);
    }
    ...
    void betCardTest() {
        ...
        Player player2 = new Player("2","player2", 0, cardsPlayer2, false, null);
        Player player3 = new Player("3", "player3",0, cardsPlayer3, false, null);
        players.add(player1);
        players.add(player2);
        players.add(player3);
        ...
        turn.put(2,player2);
        turn.put(3,player3);
        Board board = new Board("1",null,turn,null);
        ...
        StepVerifier.create(betCardUseCase.apply(game, card1.getId()))
        ...
        verify(gameRepository, times(4)).save(Mockito.any(Game.class));
    }
}