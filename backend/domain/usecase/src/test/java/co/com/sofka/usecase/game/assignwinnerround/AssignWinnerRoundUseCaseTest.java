...
class AssignWinnerRoundUseCaseTest {
    ...
    void setUp() {
        ...
        assignWinnerRoundUseCase = new AssignWinnerRoundUseCase(gameRepository, countCardPlayerUseCase);
    }

    @Test
    void assignWinnerTest() {
        ...
        StepVerifier.create(assignWinnerRoundUseCase.apply(game,player1.getId()))
