...
class ComparateCardsInGameUseCaseTest {
    ...
    void setUp() {
        ...
        comparateCardsInGameUseCase = new ComparateCardsInGameUseCase(assignWinnerRoundUseCase);
    }

    @Test
    void comparateCardsInGameTest() {
        ...
        StepVerifier.create(comparateCardsInGameUseCase.apply(game))
